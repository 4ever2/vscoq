...
import { AnnotatedText, ScopedText, TextAnnotation, isScopedText, isTextAnnotation } from '@lib/AnnotatedText';
export { AnnotatedText, ScopedText, TextAnnotation, isScopedText, isTextAnnotation, textToString, textToDisplayString } from '@lib/AnnotatedText';
