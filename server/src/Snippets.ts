...
const optionsSnippets : TriggerSnippet[] = [
  ...
  {label: "Apply With Renaming", addedIn: "8.15", deprecatredIn: "8.15"},
  ...
  {label: "Elaboration StrictProp Cumulativity", addedIn: "8.10"},
  ...
  {label: "Typeclasses Filtered Unification", addedIn: "8.6", deprecatredIn: "8.16"},
