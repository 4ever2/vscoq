...
const optionsSnippets : TriggerSnippet[] = [
  {label: "Allow StrictProp", addedIn: "8.10.0"},
  {label: "Apply With Renaming", addedIn: "8.15.0", deprecatredIn: "8.15.0"},
  {label: "Asymmetric Patterns", addedIn: "8.5.0"},
  {label: "Atomic Load", removedIn: "8.7.0"},
  {label: "Automatic Coercions Import", deprecatredIn: "8.7.0", removedIn: "8.10.0"},
  {label: "Automatic Introduction", deprecatredIn: "8.7.0", removedIn: "8.10.0"},
  {label: "Auto Template Polymorphism", addedIn: "8.10.0"},
  {label: "Boolean Equality Schemes"},
  {label: "Bracketing Last Introduction Pattern", deprecatredIn: "8.10.0", removedIn: "8.14.0"},
  {label: "Bullet Behavior", insertText: "Bullet Behavior \"${1|None,Strict Subproofs|}\"."},
  {label: "Case Analysis Schemes"},
  {label: "Compat Notations", removedIn: "8.6.0"},
  {label: "Congruence Depth", insertText: "Congruence Depth ${1:num}.", deprecatredIn: "8.7.0", removedIn: "8.11.0"},
  {label: "Congruence Verbose", removedIn: "8.14.0"},
  {label: "Contextual Implicit"},
  {label: "Coqtop Exit On Error", addedIn: "8.10.0"},
  {label: "Cumulative StrictProp", addedIn: "8.12.0"},
  {label: "Cumulativity Weak Constraints", addedIn: "8.8.0"},
  {label: "Debug", insertText:"Debug \"${1:ident}\".", addedIn: "8.14.0"},
  {label: "Debug Auto"},
  {label: "Debug Cbv", addedIn: "8.7.0", removedIn: "8.14.0"},
  {label: "Debug Eauto"},
  {label: "Debug Ltac", addedIn: "8.7.0", removedIn: "8.10.0"},
  {label: "Debug HO Unification", addedIn: "8.10.0", removedIn: "8.14.0"},
  {label: "Debug RAKAM", addedIn: "8.5.0", removedIn: "8.14.0"},
  {label: "Debug Tactic Unification", addedIn: "8.5.0", removedIn: "8.14.0"},
  {label: "Debug Trivial"},
  {label: "Debug Typeclasses", addedIn: "8.6.0", removedIn: "8.10.0"},
  {label: "Debug Unification", removedIn: "8.14.0"},
  {label: "Decidable Equality Schemes"},
  {label: "Default Clearing Used Hypotheses", addedIn: "8.5.0"},
  {label: "Default Goal Selector", insertText: "Default Goal Selector \"${1:selector}\".", addedIn: "8.5.0"},
  {label: "Default Proof Mode", insertText: "Default Proof Mode \"${1|Classic,Noedit,Ltac2|}\"."},
  {label: "Default Proof Using", insertText: "Default Proof Using \"${1:section_var_expr}\".", addedIn: "8.5.0"},
  {label: "Default Timeout", insertText: "Default Timeout ${1:num}."},
  {label: "Definitional UIP", addedIn: "8.13.0"},
  {label: "Dependent Propositions Elimination", deprecatredIn: "8.7.0", removedIn: "8.8.0"},
  {label: "Discriminate Introduction", deprecatredIn: "8.7.0", removedIn: "8.8.0"},
  {label: "Diffs", addedIn: "8.9.0"},
  {label: "Dump Bytecode", addedIn: "8.5.0"},
  {label: "Dump Lambda", addedIn: "8.8.0"},
  {label: "Elaboration StrictProp Cumulativity", addedIn: "8.10.0"},
  {label: "Elimination Schemes"},
  {label: "Equality Scheme", deprecatredIn: "8.4.0", removedIn: "8.7.0"},
  {label: "Extraction AccessOpaque"},
  {label: "Extraction AutoInline"},
  {label: "Extraction Conservative Types", addedIn: "8.5.0"},
  {label: "Extraction File Comment", insertText: "Extraction File Comment \"${1:string}\".", addedIn: "8.5.0"},
  {label: "Extraction Flag", insertText: "Extraction Flag ${1:num}."},
  {label: "Extraction KeepSingleton"},
  {label: "Extraction Optimize"},
  {label: "Extraction SafeImplicits", addedIn: "8.5.0"},
  {label: "Extraction TypeExpand"},
  {label: "Fast Name Printing", addedIn: "8.10.0"},
  {label: "Firstorder Depth", insertText: "Firstorder Depth ${1:num}."},
  {label: "Firstorder Solver", insertText: "Firstorder Solver ${1:ltac_expr}."},
  {label: "Function_debug", removedIn: "8.7.0"},
  {label: "Function_raw_tcc", removedIn: "8.7.0"},
  {label: "Functional Induction Rewrite Dependent", removedIn: "8.7.0"},
  {label: "Guard Checking", addedIn: "8.11.0"},
  {label: "Hide Obligations", deprecatredIn: "8.12.0", removedIn: "8.14.0"},
  {label: "Hyps Limit", insertText: "Hyps Limit ${1:num}."},
  {label: "Implicit Arguments"},
  {label: "Info Auto"},
  {label: "Info Eauto"},
  {label: "Info Level", insertText: "Info Level ${1:num}.", addedIn: "8.5.0"},
  {label: "Info Trivial"},
  {label: "Injection L2R Pattern Order", deprecatredIn: "8.7.0", removedIn: "8.8.0"},
  {label: "Injection On Proofs", removedIn: "8.6.0"},
  {label: "Inline Level", insertText: "Inline Level ${1:num}."},
  {label: "Instance Generalized Output", addedIn: "8.13.0", deprecatredIn: "8.13.0", removedIn: "8.15.0"},
  {label: "Intuition Iff Unfolding", deprecatredIn: "8.7.0", removedIn: "8.8.0"},
  {label: "Intuition Negation Unfolding", addedIn: "8.5.0"},
  {label: "Keep Admitted Variables", addedIn: "8.5.0"},
  {label: "Keep Proof Equalities", addedIn: "8.6.0"},
  {label: "Kernel Term Sharing", addedIn: "8.5.0"},
  {label: "Keyed Unification", addedIn: "8.5.0"},
  {label: "Loose Hint Behavior", insertText: "Loose Hint Behavior \"${1|Lax,Warn,Strict|}\".", addedIn: "8.5.0"},
  {label: "Ltac Backtrace", addedIn: "8.10.0"},
  {label: "Ltac Batch Debug", addedIn: "8.7.0"},
  {label: "Ltac Debug"},
  {label: "Ltac Profiling", addedIn: "8.6.0"},
  {label: "Mangle Names", addedIn: "8.8.0"},
  {label: "Mangle Names Light", addedIn: "8.15.0"},
  {label: "Mangle Names Prefix", insertText: "Mangle Names Prefix \"${1:string}\"."},
  {label: "Maximal Implicit Insertion"},
  {label: "NativeCompute Profile Filename", insertText: "NativeCompute Profile Filename \"${1:string}\".", addedIn: "8.8.0"},
  {label: "NativeCompute Profiling", addedIn: "8.8.0"},
  {label: "NativeCompute Timing", addedIn: "8.12.0"},
  {label: "Nested Proofs Allowed", addedIn: "8.9.0"},
  {label: "Nonrecursive Elimination Schemes", addedIn: "8.5.0"},
  {label: "Parsing Explicit"},
  {label: "Polymorphic Inductive Cumulativity", addedIn: "8.7.0"},
  {label: "Positivity Checking", addedIn: "8.11.0"},
  {label: "Primitive Projections", addedIn: "8.5.0"},
  {label: "Printing All"},
  {label: "Printing Allow Match Default Clause", addedIn: "8.8.0"},
  {label: "Printing Coercions"},
  {label: "Printing Compact Contexts", addedIn: "8.7.0"},
  {label: "Printing Dependent Evars Line", addedIn: "8.6.0"},
  {label: "Printing Depth", insertText: "Printing Depth ${1:num}."},
  {label: "Printing Existential Instances"},
  {label: "Printing Factorizable Match Patterns", addedIn: "8.8.0"},
  {label: "Printing Float", addedIn: "8.13.0"},
  {label: "Printing Goal Names", addedIn: "8.7.0"},
  {label: "Printing Goal Tags", addedIn: "8.7.0"},
  {label: "Printing Implicit"},
  {label: "Printing Implicit Defensive"},
  {label: "Printing Matching"},
  {label: "Printing Notations"},
  {label: "Printing Parentheses", addedIn: "8.12.0"},
  {label: "Printing Primitive Projection Compatibility", addedIn: "8.5.0", removedIn: "8.10.0"},
  {label: "Printing Primitive Projection Parameters", addedIn: "8.5.0"},
  {label: "Printing Projections"},
  {label: "Printing Raw Literals", addedIn: "8.14.0"},
  {label: "Printing Records"},
  {label: "Printing Synth"},
  {label: "Printing Unfocused", addedIn: "8.7.0"},
  {label: "Printing Universes"},
  {label: "Printing Use Implicit Types", addedIn: "8.12.0"},
  {label: "Printing Width", insertText: "Printing Width ${1:num}."},
  {label: "Printing Wildcard"},
  {label: "Private Polymorphic Universes", addedIn: "8.10.0"},
  {label: "Program Cases", addedIn: "8.6.0"},
  {label: "Program Generalized Coercion", addedIn: "8.6.0"},
  {label: "Program Mode", addedIn: "8.5.0"},
  {label: "Program Naming", addedIn: "8.16.0", deprecatredIn: "8.16.0", removedIn: "8.17.0"},
  {label: "Proof Using Clear Unused", addedIn: "8.5.0", removedIn: "8.10.0"},
  {label: "Record Elimination Schemes", deprecatredIn: "8.5.0", removedIn: "8.8.0"},
  {label: "Refine Instance Mode", addedIn: "8.5.0", deprecatredIn: "8.10.0", removedIn: "8.11.0"},
  {label: "Refolding Reduction", addedIn: "8.6.0", deprecatredIn: "8.7.0", removedIn: "8.8.0"},
  {label: "Regular Subst Tactic", addedIn: "8.5.0", deprecatredIn: "8.14.0", removedIn: "8.15.0"},
  {label: "Reversible Pattern Implicit"},
  {label: "Rewriting Schemes"},
  {label: "Search Output Name Only", addedIn: "8.6.0"},
  {label: "Short Module Printing"},
  {label: "Shrink Abstract", deprecatredIn: "8.6.0", removedIn: "8.8.0"},
  {label: "Shrink Obligations", deprecatredIn: "8.6.0", removedIn: "8.12.0"},
  {label: "Silent"},
  {label: "SimplIsCbn"},
  {label: "Solve Unification Constraints", addedIn: "8.6.0"},
  {label: "Standard Proposition Elimination Names", deprecatredIn: "8.7.0", removedIn: "8.8.0"},
  {label: "Strict Implicit"},
  {label: "Strict Proofs", removedIn: "8.7.0"},
  {label: "Strict Universe Declaration"},
  {label: "Strongly Strict Implicit"},
  {label: "Structural Injection", addedIn: "8.6.0"},
  {label: "Suggest Proof Using"},
  {label: "Tactic Compat Context", deprecatredIn: "8.7.0", removedIn: "8.8.0"},
  {label: "Tactic Evars Pattern Unification", deprecatredIn: "8.5.0", removedIn: "8.7.0"},
  {label: "Tactic Pattern Unification", deprecatredIn: "8.7.0", "removedIn": "8.8.0"},
  {label: "Template Check", addedIn: "8.10.0", deprecatredIn: "8.10.0", removedIn: "8.12.0"},
  {label: "Transparent Obligations"},
  {label: "Typeclass Resolution After Apply", deprecatredIn: "8.6.0", removedIn: "8.8.0"},
  {label: "Typeclass Resolution For Conversion"},
  {label: "Typeclasses Axioms Are Instances", addedIn: "8.8.0", deprecatredIn: "8.10.0", removedIn: "8.12.0"},
  {label: "Typeclasses Debug"},
  {label: "Typeclasses Debug Verbosity", insertText: "Typeclasses Debug Verbosity ${1:num}.", addedIn: "8.6.0"},
  {label: "Typeclasses Dependency Order"},
  {label: "Typeclasses Depth", insertText: "Typeclasses Depth ${1:num}."},
  {label: "Typeclasses Filtered Unification", addedIn: "8.6.0", deprecatredIn: "8.16.0"},
  {label: "Typeclasses Iterative Deepening", addedIn: "8.6.0"},
  {label: "Typeclasses Legacy Resolution", addedIn: "8.6.0", deprecatredIn: "8.7.0", removedIn: "8.8.0"},
  {label: "Typeclasses Limit Intros", addedIn: "8.6.0"},
  {label: "Typeclasses Modulo Eta", deprecatredIn: "8.6.0", removedIn: "8.8.0"},
  {label: "Typeclasses Strict Resolution"},
  {label: "Typeclasses Unique Instances"},
  {label: "Typeclasses Unique Solutions"},
  {label: "Undo", deprecatredIn: "8.4.0",removedIn: "8.7.0"},
  {label: "Uniform Inductive Parameters", addedIn: "8.9.0"},
  {label: "Universal Lemma Under Conjunction", deprecatredIn: "8.15.0", removedIn: "8.16.0"},
  {label: "Universe Checking", addedIn: "8.11.0"},
  {label: "Universe Minimization ToSet"},
  {label: "Universe Polymorphism"},
  {label: "Verbose Compat Notations", removedIn: "8.6.0"},
  {label: "Warnings", insertText: "Warnings \"${1:ident}\"", addedIn: "8.6.0"},
];

const rawTableSnippets : TriggerSnippet[] = [
  {label: "Keep Equalities", addedIn: "8.15.0"},
...
const printSnippets : TriggerSnippet[] = [
  ...
  {label: "Canonical Projections", removedIn: "8.12.0"},
  {label: "Canonical Projections", insertText: "Canonical Projections ${1:qualid}.", addedIn: "8.12.0"},
  {label: "Classes"},
  {label: "Coercion Paths", insertText: "Coercion Paths ${1:class1} ${2:class2}."},
  {label: "Coercions"},
  {label: "Custom Grammar", insertText: "Custom Grammar ${1:ident}.", addedIn: "8.10.0"},
  {label: "Debug GC"},
  ...
  {label: "Ltac Signatures", addedIn: "8.6.0"},
  {label: "Ltac2", insertText: "Ltac2 ${1:qualid}.", addedIn: "8.11.0"},
  {label: "ML Modules"},
  {label: "ML Path"},
  {label: "Module", insertText: "Module ${1:ident}."},
  {label: "Module Type", insertText: "Module Type ${1:ident}."},
  {label: "Notation", insertText: "Notation \"${1:string}\".", addedIn: "8.16.0"},
  ...
  {label: "Typing Flags", addedIn: "8.11.0"},
  {label: "Universes"},
...
const showSnippets : TriggerSnippet[] = [
  ...
  {label: "Proof"},
  {label: "Script", deprecatredIn: "8.10.0", removedIn: "8.11.0"},
  {label: "Universes"},
];

const hintSnippets : TriggerSnippet[] = [
  {label: "Constants", insertText: "Constants ${1|Opaque,Transparent|} : ${2:idents …}.", addedIn: "8.9.0"},
  ...
  {label: "Variables", insertText: "Variables ${1|Opaque,Transparent|} : ${2:idents …}.", addedIn: "8.9.0"},
];
